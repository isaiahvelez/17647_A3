...
public class BackendProxyService {
    ...
    private ResponseEntity<String> adaptResponse(HttpServletRequest request, ResponseEntity<String> backendResponse) {
        ...
        // The mobile app needs a slightly smaller read shape without changing the backend contract.
        String body = responseTransformer.transform(request, backendResponse);
